...
export default {
    template: `
        ...
        <div class="fixed md:relative inset-y-0 right-0 bg-gray-950/60 backdrop-blur-xl border-l border-white/5 flex flex-col h-screen flex-shrink-0 z-40 transition-all duration-300"
             :class="store.isPromptPanelOpen ? 'w-[320px] translate-x-0' : 'w-0 translate-x-full md:translate-x-0 border-none overflow-hidden'">
            
            <div class="flex flex-col h-full w-[320px]">

                <!-- Header -->
                <div class="p-5 flex justify-between items-center border-b border-white/5 bg-white/5">
                    ...
                    <button @click="store.isPromptPanelOpen = false" class="p-1.5 rounded-lg hover:bg-white/10 text-gray-500 hover:text-white transition-colors">
