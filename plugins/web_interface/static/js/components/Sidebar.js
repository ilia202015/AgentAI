...
export default {
    template: `
        <div>
            ...
            <!-- Sidebar Container -->
            <div class="fixed md:relative inset-y-0 left-0 bg-gray-900/40 border-r border-white/5 flex flex-col h-full flex-shrink-0 z-[70] transition-all duration-300 ease-in-out overflow-hidden"
                 :class="[
                ...
                <div class="absolute inset-0 backdrop-blur-md pointer-events-none z-0"></div>
